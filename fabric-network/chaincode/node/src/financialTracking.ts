...
export class financialTracking extends Chaincode {


    //--------------------- LedgerSafe Stuff ------------------------- //
    async queryBusiness(stubHelper: StubHelper, args: string[]): Promise<any> {
    ...
    async queryFI(stubHelper: StubHelper, args: string[]): Promise<any> {
    ...
    async queryAllTransactions(stubHelper: StubHelper, args: string[]): Promise<any> {
    ...
    async b2cTransaction(stubHelper: StubHelper, args: string[]): Promise<any> {
    ...
    async b2bTransaction(stubHelper: StubHelper, args: string[]): Promise<any> {
    ...
    async deposit(stubHelper: StubHelper, args: string[]): Promise<any> {
    ...
    async withdrawal(stubHelper: StubHelper, args: string[]): Promise<any> {
